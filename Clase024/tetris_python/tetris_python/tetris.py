...
def remove_empty_columns(arr, _x_offset=0, _keep_counting=True):
    """
    Elimine las columnas vacías de arr (es decir, aquellas llenas de ceros).
     El valor de retorno es (new_arr, x_offset), donde x_offset es cómo
     mucho es necesario aumentar la coordenada x para mantener
...
class Block(pygame.sprite.Sprite):
    ...
    def collide(block, group):
        """
        Comprueba si el bloque especificado colisiona con algún otro bloque
        en el grupo.
        """
