...
class Persona:
    ...
    def __ne__(self, __otro_objeto: object) -> bool:
        return not self.__eq__(__otro_objeto)
...
def main():
    ...
    p1 = Persona(25478123,"Juan",35)
    print(p1)
    a = int()
    print(a)
    
    if p.es_mayor_de_edad():
        print(f'{p.getNombre()} es mayor de edad')
    ...
    p1.setNombre("ñsfldgñlfdñlgbñdflñlbñgfdhñ")
